...
/**
 * US QWERTY (ANSI) keyboard layout, standard touch-typing finger
 * assignment. No AltGr layer and no dead keys — every printable character
 * is reachable with base or Shift alone.
 */
